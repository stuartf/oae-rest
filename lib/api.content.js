 ...
 * @param  {String[]}       [folderIds]         Array of folder ids where the content item should be added to
 * @param  {Function}       callback            Standard callback method
 * @param  {Object}         callback.err        Error object containing error code and error message
 * @param  {Content}        callback.content    Content object representing the created content
 */
var createLink = module.exports.createLink = function(restCtx, displayName, description, visibility, link, managers, viewers, folderIds, callback) {
    var params = {
 ...
 * @param  {Content}        callback.content    Content object representing the created content
 */
var createFile = module.exports.createFile = function(restCtx, displayName, description, visibility, fileGenerator, managers, viewers, folderIds, callback) {
    var params = {
 ...
 * @param  {Content}      callback.content    Content object representing the created content
 */
var createCollabDoc = module.exports.createCollabDoc = function(restCtx, displayName, description, visibility, managers, viewers, folderIds, callback) {
    var params = {
